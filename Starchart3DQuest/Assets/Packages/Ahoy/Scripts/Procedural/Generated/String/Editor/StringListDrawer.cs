...
/*AUTO SCRIPT*/{
/*AUTO SCRIPT*/
/*AUTO SCRIPT*/	[CustomPropertyDrawer(typeof(StringList), true)]
/*AUTO SCRIPT*/	public class StringListDrawer : PropertyDrawer
/*AUTO SCRIPT*/	{
/*AUTO SCRIPT*/		public int numLines = 1;
/*AUTO SCRIPT*/
/*AUTO SCRIPT*/		ReorderableList rList;
/*AUTO SCRIPT*/		StringList list;
/*AUTO SCRIPT*/		// string defaultVal;
/*AUTO SCRIPT*/
...
/*AUTO SCRIPT*/			{
/*AUTO SCRIPT*/				list = EditorUtility.GetPropertyObject<StringList>(property);
/*AUTO SCRIPT*/				rList = new ReorderableList(list, typeof(string), true, false, true, true);
