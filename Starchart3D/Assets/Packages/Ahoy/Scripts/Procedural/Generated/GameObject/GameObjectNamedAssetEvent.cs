...
/*AUTO SCRIPT*/{
/*AUTO SCRIPT*/	[CreateAssetMenu(fileName = "GameObjectNamedAssetEvent", menuName = "Ahoy/Asset Events/GameObject - named", order = 0)]
/*AUTO SCRIPT*/	public class GameObjectNamedAssetEvent : InvocableSO
/*AUTO SCRIPT*/	{
/*AUTO SCRIPT*/		public bool debug;
/*AUTO SCRIPT*/		public GameObject constantValue;
/*AUTO SCRIPT*/
/*AUTO SCRIPT*/		public new string name = "GameObject named event";
/*AUTO SCRIPT*/
/*AUTO SCRIPT*/		// public List<GameObjectNamedUnityEvent> listeners = new List<GameObjectNamedUnityEvent>();
/*AUTO SCRIPT*/		public List<GameObjectNamedUnityEvent> unityEventListeners;
/*AUTO SCRIPT*/		public List<GameObjectAssetEvent> assetEventListeners;
/*AUTO SCRIPT*/		AhoyEvent<string, GameObject> ahoyEvent = new AhoyEvent<string, GameObject>();
/*AUTO SCRIPT*/
...
/*AUTO SCRIPT*/		}
/*AUTO SCRIPT*/
/*AUTO SCRIPT*/		public void RemoveListener(Action<string, GameObject> action)
/*AUTO SCRIPT*/		{
/*AUTO SCRIPT*/			ahoyEvent.RemoveListener(action);
/*AUTO SCRIPT*/		}
/*AUTO SCRIPT*/
/*AUTO SCRIPT*/		public void AddListener(GameObjectNamedUnityEvent listener)
/*AUTO SCRIPT*/		{
/*AUTO SCRIPT*/			unityEventListeners.TryAdd(listener);
/*AUTO SCRIPT*/		}
/*AUTO SCRIPT*/		public void RemoveListener(GameObjectNamedUnityEvent listener)
/*AUTO SCRIPT*/		{
