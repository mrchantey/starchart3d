...
/*AUTO SCRIPT*/{
/*AUTO SCRIPT*/
/*AUTO SCRIPT*/	[CustomPropertyDrawer(typeof(ComputeBufferList), true)]
/*AUTO SCRIPT*/	public class ComputeBufferListDrawer : PropertyDrawer
/*AUTO SCRIPT*/	{
/*AUTO SCRIPT*/		public int numLines = 1;
/*AUTO SCRIPT*/
/*AUTO SCRIPT*/		ReorderableList rList;
/*AUTO SCRIPT*/		ComputeBufferList list;
/*AUTO SCRIPT*/		// ComputeBuffer defaultVal;
/*AUTO SCRIPT*/
...
/*AUTO SCRIPT*/			{
/*AUTO SCRIPT*/				list = EditorUtility.GetPropertyObject<ComputeBufferList>(property);
/*AUTO SCRIPT*/				rList = new ReorderableList(list, typeof(ComputeBuffer), true, false, true, true);
