...
/*AUTO SCRIPT*/{
/*AUTO SCRIPT*/    [CreateAssetMenu(fileName = "ComputeBufferAssetEvent", menuName = "Ahoy/Asset Events/ComputeBuffer", order = 0)]
/*AUTO SCRIPT*/    public class ComputeBufferAssetEvent : InvocableSO
/*AUTO SCRIPT*/    {
/*AUTO SCRIPT*/        public bool debug;
/*AUTO SCRIPT*/        public ComputeBuffer constantValue;
/*AUTO SCRIPT*/
/*AUTO SCRIPT*/        // public List<ComputeBufferUnityEvent> listeners = new List<ComputeBufferUnityEvent>();
/*AUTO SCRIPT*/        public List<ComputeBufferUnityEvent> unityEventListeners;
/*AUTO SCRIPT*/        public List<ComputeBufferAssetEvent> assetEventListeners;
/*AUTO SCRIPT*/        AhoyEvent<ComputeBuffer> ahoyEvent = new AhoyEvent<ComputeBuffer>();
/*AUTO SCRIPT*/
...
/*AUTO SCRIPT*/        }
/*AUTO SCRIPT*/
/*AUTO SCRIPT*/        public void RemoveListener(Action<ComputeBuffer> action)
/*AUTO SCRIPT*/        {
/*AUTO SCRIPT*/            ahoyEvent.RemoveListener(action);
/*AUTO SCRIPT*/        }
/*AUTO SCRIPT*/
/*AUTO SCRIPT*/        public void AddListener(ComputeBufferUnityEvent listener)
/*AUTO SCRIPT*/        {
/*AUTO SCRIPT*/            unityEventListeners.TryAdd(listener);
/*AUTO SCRIPT*/        }
/*AUTO SCRIPT*/        public void RemoveListener(ComputeBufferUnityEvent listener)
/*AUTO SCRIPT*/        {
