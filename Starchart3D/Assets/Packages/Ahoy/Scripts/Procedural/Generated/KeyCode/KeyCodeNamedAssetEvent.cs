...
/*AUTO SCRIPT*/{
/*AUTO SCRIPT*/	[CreateAssetMenu(fileName = "KeyCodeNamedAssetEvent", menuName = "Ahoy/Asset Events/KeyCode - named", order = 0)]
/*AUTO SCRIPT*/	public class KeyCodeNamedAssetEvent : InvocableSO
/*AUTO SCRIPT*/	{
/*AUTO SCRIPT*/		public bool debug;
/*AUTO SCRIPT*/		public KeyCode constantValue;
/*AUTO SCRIPT*/
/*AUTO SCRIPT*/		public new string name = "KeyCode named event";
/*AUTO SCRIPT*/
/*AUTO SCRIPT*/		// public List<KeyCodeNamedUnityEvent> listeners = new List<KeyCodeNamedUnityEvent>();
/*AUTO SCRIPT*/		public List<KeyCodeNamedUnityEvent> unityEventListeners;
/*AUTO SCRIPT*/		public List<KeyCodeAssetEvent> assetEventListeners;
/*AUTO SCRIPT*/		AhoyEvent<string, KeyCode> ahoyEvent = new AhoyEvent<string, KeyCode>();
/*AUTO SCRIPT*/
...
/*AUTO SCRIPT*/		}
/*AUTO SCRIPT*/
/*AUTO SCRIPT*/		public void RemoveListener(Action<string, KeyCode> action)
/*AUTO SCRIPT*/		{
/*AUTO SCRIPT*/			ahoyEvent.RemoveListener(action);
/*AUTO SCRIPT*/		}
/*AUTO SCRIPT*/
/*AUTO SCRIPT*/		public void AddListener(KeyCodeNamedUnityEvent listener)
/*AUTO SCRIPT*/		{
/*AUTO SCRIPT*/			unityEventListeners.TryAdd(listener);
/*AUTO SCRIPT*/		}
/*AUTO SCRIPT*/		public void RemoveListener(KeyCodeNamedUnityEvent listener)
/*AUTO SCRIPT*/		{
